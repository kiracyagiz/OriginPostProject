  ...
  return (
    <div className="  flex flex-col items-center  p-8 md:p-0 mx-auto mt-36  gap-y-8">
      <div className="text-center">
        ...
        <p className="text-black tracking-tight">{t("desc")}</p>
      </div>
      <div className="flex flex-col gap-y-2">
        <p className="text-sm">
          {t("phone")}
          <span className="font-bold">+355672014274</span>
        </p>
        <p className="text-sm">
          Email:<span className="font-bold">info@pos.al</span>
        </p>
      </div>

      <div className="flex flex-col items-start md:flex-row gap-y-4 gap-x-4">
